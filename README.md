...
* **NB** First make sure you virtual environmant is activated
...
```
* After the djngo projected has been installed , will need to install a couple of dependnancies that we are going to use in this project
We need to install 
```cmd
